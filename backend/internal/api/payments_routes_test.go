...
func TestAdminPaymentAndUserRoutesRequireAuth(t *testing.T) {
	...
	routes := []struct {
		...
		{http.MethodGet, "/api/admin/users/11111111-1111-1111-1111-111111111111/recovery-email"},
		{http.MethodPut, "/api/admin/users/11111111-1111-1111-1111-111111111111/recovery-email"},
		{http.MethodDelete, "/api/admin/users/11111111-1111-1111-1111-111111111111/recovery-email"},
